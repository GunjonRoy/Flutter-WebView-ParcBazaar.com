...
void main() => runApp(const MaterialApp(home: CheapCityBdWebViewPage()));
...
class CheapCityBdWebViewPage extends StatefulWidget {
  const CheapCityBdWebViewPage({Key? key, this.cookieManager}) : super(key: key);

  final CookieManager? cookieManager;

  @override
  State<CheapCityBdWebViewPage> createState() => _CheapCityBdWebViewPageState();
}

class _CheapCityBdWebViewPageState extends State<CheapCityBdWebViewPage> {
