...
class ParcbazaarWebViewPage extends StatefulWidget {
  const ParcbazaarWebViewPage({Key? key, this.cookieManager}) : super(key: key);

  final CookieManager? cookieManager;

  @override
  State<ParcbazaarWebViewPage> createState() => _ParcbazaarWebViewPageState();
}
